...
-- DROP TABLE IF EXISTS "ODS_CUSTOMER_TYPE" ;
CREATE TABLE "ORION_ODS"."ODS_CUSTOMER_TYPE" 
(
	"CUSTOMER_TYPE_ID" 	INT     NOT NULL,
	"CUSTOMER_TYPE" 	VARCHAR(40) NOT NULL,
	"CUSTOMER_GROUPE_ID" 	INT     NOT NULL,
	"CUSTOMER_GROUPE" 	VARCHAR(40) NOT NULL,
...
-- DROP TABLE IF EXISTS "ODS_PRODUCT_LEVEL" ;
CREATE TABLE "ORION_ODS"."ODS_PRODUCT_LEVEL" 
(
	"PRODUCT_LEVEL" 		INTEGER     NOT NULL,
	"PRODUCT_LEVEL_NAME" 	VARCHAR(20) NOT NULL,
	"LB_NOM_FICHIER" 	VARCHAR(100) NOT NULL,
	"DT_INSERTION" 	TIMESTAMP NOT NULL,
	"BL_LIGNE_ACTIVE" 	INTEGER NOT NULL,
	"LB_JOB_NAME" 	VARCHAR(100) NOT NULL
...
DROP TABLE IF EXISTS "ODS_PRODUCT_LIST" ;
...
DROP TABLE IF EXISTS "ODS_SUPPLIER" ;
...
DROP TABLE IF EXISTS "ODS_CONTINENT" ;
...
DROP TABLE IF EXISTS "ODS_COUNTRY" ;
...
DROP TABLE IF EXISTS "ODS_COUNTY" ;
